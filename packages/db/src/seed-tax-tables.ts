...
const SEED: SeedRow[] = [
  // -----------------------------------------------------------------
  // 2023 federal income tax brackets (Rev. Proc. 2022-38)
  // -----------------------------------------------------------------
  {
    taxYear: 2023,
    kind: "federal_tax_brackets",
    effectiveFrom: utcJan1(2023),
    sourceUrl: "https://www.irs.gov/pub/irs-drop/rp-22-38.pdf",
    sourceVersion: "Rev. Proc. 2022-38",
    payload: {
      single: [
        { rate: 0.1, upto: 11000 },
  ...
  },
  {
    ...
    sourceUrl: "https://www.irs.gov/pub/irs-drop/rp-22-38.pdf",
    sourceVersion: "Rev. Proc. 2022-38",
    payload: { single: 13850, mfj: 27700, mfs: 13850, hoh: 20800, qw: 27700 },
  },
  {
    taxYear: 2023,
    kind: "fica_wage_base",
    ...
    sourceVersion: "SSA fact sheet 2023",
    payload: {
      wageBase: 160200,
      oasdiRate: 0.062,
      medicareRate: 0.0145,
  ...
  },
  {
    ...
    effectiveFrom: utcJan1(2023),
    sourceUrl: "https://www.irs.gov/publications/p946",
    sourceVersion: "Pub 946 (2023) — IRC §168(k) phase-out",
    payload: { pct: 0.8 },
  },
  {
    taxYear: 2023,
    ...
    effectiveFrom: utcJan1(2023),
    sourceUrl: "https://www.irs.gov/pub/irs-drop/rp-22-24.pdf",
    sourceVersion: "Rev. Proc. 2022-24",
    payload: {
      selfOnly: 3850,
      family: 7750,
      catchup55: 1000,
      hdhpDeductible: { selfOnly: 1500, family: 3000 },
      hdhpOOPMax: { selfOnly: 7500, family: 15000 },
    },
  },
  {
    taxYear: 2023,
    ...
    effectiveFrom: utcJan1(2023),
    sourceUrl: "https://www.irs.gov/pub/irs-drop/n-22-55.pdf",
    sourceVersion: "IRS Notice 2022-55",
    payload: {
      "401k": 22500,
      "401kCatchup50": 7500,
      ira: 6500,
      iraCatchup50: 1000,
      sepIra: { pct: 0.25, dollarCap: 66000 },
      simpleIra: 15500,
      simpleIraCatchup50: 3500,
      defBenAnnualMax: 265000,
    },
  },
  {
    taxYear: 2023,
    ...
    payload: {
      ...
      mfj: 126500,
      mfs: 63250,
      phaseoutStartSingle: 578150,
      phaseoutStartMfj: 1156300,
      phaseoutStartMfs: 578150,
    },
  },
  // -----------------------------------------------------------------
  ...
  // -----------------------------------------------------------------
  // 2026 federal income tax brackets (Rev. Proc. 2025-32, Oct 2025)
  // -----------------------------------------------------------------
  {
    taxYear: 2026,
    kind: "federal_tax_brackets",
    effectiveFrom: utcJan1(2026),
    sourceUrl: "https://www.irs.gov/pub/irs-drop/rp-25-32.pdf",
    sourceVersion: "Rev. Proc. 2025-32",
    payload: {
      single: [
        { rate: 0.1, upto: 12400 },
  ...
  },
  {
    ...
    sourceUrl: "https://www.irs.gov/pub/irs-drop/rp-25-32.pdf",
    sourceVersion: "Rev. Proc. 2025-32",
    payload: { single: 16100, mfj: 32200, mfs: 16100, hoh: 24150, qw: 32200 },
  },
  {
    taxYear: 2026,
    kind: "fica_wage_base",
    effectiveFrom: utcJan1(2026),
    sourceUrl: "https://www.ssa.gov/oact/cola/cbb.html",
    sourceVersion: "SSA fact sheet 2026",
    payload: {
      wageBase: 184500,
      oasdiRate: 0.062,
      medicareRate: 0.0145,
  ...
  },
  {
    ...
    effectiveFrom: utcJan1(2026),
    sourceUrl: "https://www.irs.gov/taxtopics/tc560",
    sourceVersion: "IRC §3101(b)(2) — fixed by statute, not indexed",
    payload: {
      addtlMedicareSingle: 200000,
      addtlMedicareMfj: 250000,
      addtlMedicareMfs: 125000,
  ...
  },
  {
    ...
    effectiveFrom: utcJan1(2026),
    sourceUrl: "https://www.irs.gov/forms-pubs/about-form-8960",
    sourceVersion: "IRC §1411 — fixed by statute, not indexed",
    payload: { single: 200000, mfj: 250000, mfs: 125000, hoh: 200000, qw: 250000 },
  },
  {
    taxYear: 2026,
    ...
    effectiveFrom: utcJan1(2026),
    sourceUrl: "https://www.irs.gov/pub/irs-drop/rp-25-32.pdf",
    sourceVersion: "Rev. Proc. 2025-32 (with OBBBA phase-in widening)",
    payload: {
      single: 201750,
      mfj: 403500,
      mfs: 201775,
      hoh: 201750,
      qw: 403500,
      // OBBBA widened the SSTB phase-in starting 2026: $75k single
      // (was $50k) and $150k MFJ (was $100k). The deduction phases
      // out fully at threshold + range.
      phaseInRangeSingle: 75000,
      phaseInRangeMfj: 150000,
    },
  },
  {
    taxYear: 2026,
    ...
    effectiveFrom: utcJan1(2026),
    sourceUrl: "https://www.irs.gov/pub/irs-drop/rp-25-32.pdf",
    sourceVersion: "Rev. Proc. 2025-32 (post-OBBBA $2.5M base)",
    payload: { limit: 2560000, phaseoutStart: 4090000, suvCap: 32000 },
  },
  {
    taxYear: 2026,
    kind: "bonus_depreciation_pct",
    ...
    sourceVersion: "OBBBA — H.R. 1, 119th Cong. (2025) — 100% bonus made permanent",
    payload: { pct: 1.0 },
  },
  {
    taxYear: 2026,
    ...
    sourceVersion: "Rev. Proc. 2025-19",
    payload: {
      selfOnly: 4400,
      family: 8750,
      catchup55: 1000,
      hdhpDeductible: { selfOnly: 1700, family: 3400 },
      hdhpOOPMax: { selfOnly: 8500, family: 17000 },
    },
  },
  {
    taxYear: 2026,
    ...
    sourceVersion: "IRS Notice 2025-67",
    payload: {
      "401k": 24500,
      "401kCatchup50": 8000,
      "401kCatchup60to63": 11250,
      ira: 7500,
      iraCatchup50: 1100,
      sepIra: { pct: 0.25, dollarCap: 72000 },
      simpleIra: 17000,
      simpleIraCatchup50: 4000,
      simpleIraCatchup60to63: 5250,
      defBenAnnualMax: 290000,
    },
  },
  {
    taxYear: 2026,
